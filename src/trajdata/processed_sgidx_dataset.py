...
class ProcessedSgidxUnifiedDataset(Dataset):
    # @profile
    def __init__(
        self,
        ...
        cache_location: str = "~/ssd4tb2/Datasets/.unified_data_cache",
        ...
        self.overall_desc = f"{self.model_desc}_{self.desired_dt}_{self.history_sec[1]}_{self.future_sec[1]}_{sg_idx[0]}_{sg_idx[1]}"
    ...
    def get_data_index(
        ...
        if self.centric == "scene":
            data_index_fn = partial(
                ProcessedSgidxUnifiedDataset._get_data_index_scene,
            ...
            data_index_fn = partial(
                ProcessedSgidxUnifiedDataset._get_data_index_agent,
